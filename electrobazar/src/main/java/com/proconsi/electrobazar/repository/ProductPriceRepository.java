...
public interface ProductPriceRepository extends JpaRepository<ProductPrice, Long> {
         ...
         * - The given timestamp is on or before the endDate, OR the endDate is null
         * (open-ended).
         *
         * @param productId the ID of the product
         * @param now       the timestamp to evaluate against
         * @return an Optional containing the active ProductPrice, or empty if none
         *         found
         */
        @Query("""
        ...
        /**
         * Fetches all price records for a given product, ordered by startDate
         * descending.
         *
         * @param productId the ID of the product
